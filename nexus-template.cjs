...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Grant Portfolio Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Grant Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "grant_record_records";
'use strict';
